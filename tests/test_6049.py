...
class test_6049(GaiaTestCase):
    _Description = "CLONE - Verify that the SMS conversation window shows the message preview (only one incoming SMS message in the conversation thread)"
