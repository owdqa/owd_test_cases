...
class main(GaiaTestCase):
    ...
    def setUp(self):
        ...
        local_dir = "tests/LOOP/aux_files/scenarios/urls/multiple/mixed/same_day/idb"
        # Prepopulate urls
    ...
    def test_run(self):
        ...
        self.UTILS.test.TEST(
            previous - 2 == current,
            "Check that after deleting just revoked URLs when there are revoked and available, the available remains")
