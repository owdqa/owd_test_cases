# 35096: Verify that the call type is Audio+Video, if the default Call Type is marked as Audio+Video
import time
import sys
sys.path.insert(1, "./")
...
class main(GaiaTestCase):
    ...
    def test_run(self):
        ...
        if result:
            ...
            self.UTILS.test.test(not "setting-disabled" in video_mode.get_attribute("class"), "Video is disabled when call mode is set to 'Audio'")