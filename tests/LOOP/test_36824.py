# OWD - 36824
# Delete the NO revoked URL in Shared URL when there are only Avalibale URLs - Clean Shared Links - Clean All
...
class main(SpreadtrumTestCase):
    ...
    def test_run(self):
        ...
        self.UTILS.test.test(
            ...
            "Check that after deleting all URLs when there are only available, there's nothing")
