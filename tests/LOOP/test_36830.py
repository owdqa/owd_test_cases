# OWD - 36830
# Delete the revoked URL in Shared URL when there are more than one
# revoked URL - Clean Shared Links - Clean Just Disabled links
...
class main(GaiaTestCase):
    ...
    def setUp(self):
        ...
        self.scenario = "scenarios/urls/multiple/revoked/same_day/idb"
