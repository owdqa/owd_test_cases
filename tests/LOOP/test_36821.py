...
# entries in different days - Clean Shared Links - Clean All
...
class main(GaiaTestCase):
    ...
    def setUp(self):
        ...
        local_dir = "tests/LOOP/aux_files/scenarios/urls/multiple/available/diff_day/idb"
        # Prepopulate urls
    ...
    def test_run(self):
        ...
        self.UTILS.test.TEST(
            previous - 3 == current,
            "Check that after deleting all URLs of different days when there are only available, there's nothing")
