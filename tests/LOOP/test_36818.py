# OWD - 36818
# Delete the revoked URL in Shared URL when there are revoked entries in
# different days - Clean Shared Links - Clean Just Disabled links
...
class main(GaiaTestCase):
    ...
    def setUp(self):
        ...
        local_dir = "tests/LOOP/aux_files/scenarios/urls/multiple/revoked/diff_day/idb"
