...
#       ER1
#       3. Wait enough time until the download finishes
#       ER2

# ** Expected Results
#       ER1 Downloading icon is displayed in the status bar
#       ER2 Downloading icon disappears after completing the download
