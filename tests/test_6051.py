...
class test_6051(GaiaTestCase):
    _Description = "CLONE - Verify that the SMS conversation window shows the message preview (more than one SMS message in the conversation thread) "
