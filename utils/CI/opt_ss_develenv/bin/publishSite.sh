...
$PROJECT_HOME/bin/updateSoftwaresano.sh /home/develenv/temp/site tools/develenv/site /home/develenv/temp/softwaresano
rm build.xml
exit 0

#### build.xml ####
<project name="develenv" default="replace" basedir=".">
    <property name="tempSite" value="/home/develenv/temp/site"/>
    <property name="dirSite" value="/home/develenv/docs/com.softwaresano/develenv"/>
